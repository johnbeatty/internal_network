class Avo::Resources::RadiusAuthorizationRequest < Avo::BaseResource
  # self.includes = []
  # self.attachments = []
  self.model_class = ::Radius::AuthorizationRequest
  # self.search = {
  ...
  def fields
    ...
    field :authorization_status,
      as: :select,
      enum: ::Radius::AuthorizationRequest.authorization_statuses,
